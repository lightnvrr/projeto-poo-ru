package com.example.projetopooru.model;
...
public class MemoriaRepositorioCardapio implements RepositorioCardapio {
    ...
    private Map<LocalDate, com.example.projetopooru.model.CardapioDiario> banco = new HashMap<>();
    ...
    @Override public CardapioDiario obter (LocalDate data) {
        return banco.computeIfAbsent(data, k -> new com.example.projetopooru.model.CardapioDiario(k)); // Cria o cardápio automaticamente caso não exista
    }
     ...
     */
    @Override
    public void salvar (com.example.projetopooru.model.CardapioDiario cardapio) {
     ...
     */
    @Override
    public Collection<com.example.projetopooru.model.CardapioDiario> listar() {
        return banco.values();
    }
}
